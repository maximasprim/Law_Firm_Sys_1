...
import { Scale, Shield, Award, Users, ArrowRight, CheckCircle2, Star, Building2, Briefcase, FileText, Gavel, MessageCircle, Bot } from "lucide-react";
import { NavLink } from "@/components/NavLink";
import heroImage from "@/assets/hero-law-office.jpg";
import { useState } from "react";
import AIAssistantModal from "@/components/ui/assistantModal";
...
const Home = () => {
  ...
  const handleWhatsAppClick = () => {
    // Replace with your actual WhatsApp business number (format: country code + number, no spaces or special characters)
    const phoneNumber = "254727783214";
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-between fixed bottom-6 w-full px-6 z-50 gap-4">
        ...
        <div className="relative group">
          <button
            ...
            className="bg-accent hover:bg-accent/90 text-accent-foreground p-3 rounded-full shadow-gold hover:shadow-xl transition-all duration-300 hover:scale-110"
            aria-label="Open AI Assistant"
          >
            <span role="img" aria-label="AI Assistant" className="text-2xl">🤖</span>
          </button>
          {/* Tooltip */}
